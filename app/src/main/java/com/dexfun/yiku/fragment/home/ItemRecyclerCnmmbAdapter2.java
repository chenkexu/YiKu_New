 ...
 * @author Smile
 */
public class ItemRecyclerCnmmbAdapter2 extends RecyclerView.Adapter<ItemRecyclerCnmmbAdapter2.SimpleViewHolder> {


    private final Context mContext;
    private final RecyclerView mRecyclerView;
    private List<List<HOME_ENTITY.DataEntity.OrnamentsEntity.ContentEntityX>> objects = new ArrayList<>();


    public static class SimpleViewHolder extends RecyclerView.ViewHolder {
        private CenterImage pushIcon;
        private TextView viShangxin;
        private ImageView viDaifanjia;
        private TextView pushTitle;
        private TextView pushSubtitle;
        private CenterImage pushIcon1;
        private TextView viShangxin1;
        private ImageView viDaifanjia1;
...
//            viShangxin = (TextView) view.findViewById(R.id.vi_shangxin);
//            viDaifanjia = (ImageView) view.findViewById(R.id.vi_daifanjia);
...
//            viShangxin1 = (TextView) view.findViewById(R.id.vi_shangxin1);
//            viDaifanjia1 = (ImageView) view.findViewById(R.id.vi_daifanjia1);
    ...
    public ItemRecyclerCnmmbAdapter2(Context context, RecyclerView recyclerView, List<List<HOME_ENTITY.DataEntity.OrnamentsEntity.ContentEntityX>> objects) {
        this(context, recyclerView, objects.size());
        this.objects = objects;
    }

    public ItemRecyclerCnmmbAdapter2(Context context, RecyclerView recyclerView, int itemCount) {
        mContext = context;
    ...
    public void onBindViewHolder(SimpleViewHolder holder, int position) {
        ...
        HOME_ENTITY.DataEntity.OrnamentsEntity.ContentEntityX contentEntity = objects.get(position).get(0);
        HOME_ENTITY.DataEntity.OrnamentsEntity.ContentEntityX contentEntity1 = objects.get(position).get(1);
