...
public class ItemPushViewAdapter extends BaseAdapter {
    ...
    public void setObjects(List<ProductListEntity> datas) {
        this.objects.clear();
        this.objects.addAll(datas);
        notifyDataSetChanged();
    }

    public void addObjects(List<ProductListEntity> datas) {
        this.objects.addAll(datas);
        notifyDataSetChanged();
    }

    public ItemPushViewAdapter(Context context, List<ProductListEntity> objects) {
