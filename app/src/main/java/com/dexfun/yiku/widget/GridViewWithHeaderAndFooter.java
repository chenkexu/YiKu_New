...
/**
 * ArticlesHomePageEntity {@link GridView} that supports adding header rows in a
...
public class GridViewWithHeaderAndFooter extends GridView {
    ...
    /**
     * ArticlesHomePageEntity class that represents a fixed view in a list, for example a header at the top
    ...
    private static class HeaderViewGridAdapter implements WrapperListAdapter, Filterable {
         ...
         * whether the empty view should be displayed.  ArticlesHomePageEntity typical implementation will return
