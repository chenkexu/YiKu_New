...
import com.dexfun.yiku.entity.PhotoInfo;
import com.dexfun.yiku.utils.DensityUtil;
...
public class MultiImageView extends LinearLayout {
	 ...
	 * 
	 * @param measureSpec
	 *            ArticlesHomePageEntity measureSpec packed into an int
...
//		Glide.with(getContext()).load(photoInfo.url).diskCacheStrategy(DiskCacheStrategy.ALL).into(imageView);
		Picasso.get().load(photoInfo.url).into(imageView);
