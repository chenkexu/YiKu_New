...
public class DexRelativeLayout extends RelativeLayout
{
    ...
    public DexRelativeLayout(Context context)
    {
        super(context);
    }

    public DexRelativeLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    }

    public DexRelativeLayout(Context context, AttributeSet attrs, int defStyle)
    {
        super(context, attrs, defStyle);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public DexRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
