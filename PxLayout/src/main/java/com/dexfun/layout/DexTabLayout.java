...
public class DexTabLayout extends TabLayout {
    private static final int NO_VALID = -1;
    private int mTextSize;
    private boolean mTextSizeBaseWidth = false;

    public DexTabLayout(Context context) {
        this(context, null);
    }

    public DexTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DexTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initTextSizeBaseWidth(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DexTabLayout);
        mTextSizeBaseWidth = a.getBoolean(R.styleable.DexTabLayout_auto_textSize_base_width, false);
        a.recycle();
    }
