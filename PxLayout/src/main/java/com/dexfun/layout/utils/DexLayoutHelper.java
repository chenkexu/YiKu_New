...
import com.dexfun.layout.DexLayoutInfo;

import com.dexfun.layout.attr.HeightAttr;
import com.dexfun.layout.attr.MarginAttr;
...
import com.dexfun.layout.attr.PaddingAttr;
...
import com.dexfun.layout.config.AutoLayoutConifg;

public class DexLayoutHelper
{
    ...
    public DexLayoutHelper(ViewGroup host)
    {
        mHost = host;
    ...
    public static DexLayoutInfo getAutoLayoutInfo(Context context,
                                                  AttributeSet attrs)
    {

        DexLayoutInfo info = new DexLayoutInfo();
...
//            if (!isPxVal(val)) continue;
        ...
        array.recycle();
        L.e(" getLayoutInfo " + info.toString());
        return info;
    }

    public interface AutoLayoutParams
    {
        DexLayoutInfo getAutoLayoutInfo();
    }
}
