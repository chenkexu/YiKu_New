...
import com.dexfun.layout.utils.DimenUtils;
...
public class DexToolbar extends Toolbar {
    ...
    public DexToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public DexToolbar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DexToolbar(Context context) {
        this(context, null);
    }
    ...
    public static class LayoutParams extends Toolbar.LayoutParams implements DexLayoutHelper.AutoLayoutParams {
        private DexLayoutInfo mDimenLayoutInfo;

        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.mDimenLayoutInfo = DexLayoutHelper.getAutoLayoutInfo(c, attrs);
        }
