package com.dexfun.layout.config;
...
import com.dexfun.layout.utils.ScreenUtils;
...
public class AutoLayoutConifg {
    ...
    public void init(Context context) {
        getMetaData(context);
        int navigationBarHeight = DimenUtils.getNavigationBarHeight(context);
        int[] screenSize = ScreenUtils.getScreenSize(context, useDeviceSize);
        mScreenWidth = screenSize[0];
//        mScreenHeight = screenSize[1] + navigationBarHeight;
        mScreenHeight=(int)(mScreenWidth*1.72533333);
